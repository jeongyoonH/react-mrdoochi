...
class CafeexperScreenshot extends Component {
    state ={
        imgs : []
    }
    ...
    async componentDidMount(){
        ...
        console.log(screendb['marketingType']['cafe_experience']['type']['article']['image'])
        for(let val of screendb['marketingType']['cafe_experience']['type']['article']['image']){
...
export default CafeexperScreenshot;