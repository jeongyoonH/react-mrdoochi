...
class FacebookmanageScreenshot extends Component {
    state = {
        imgs : []
    }
    ...
    async componentDidMount(){
        ...
        // console.log(screendb['marketingType']['facebook_manage']['image'])
        for(let val of screendb['marketingType']['facebook_manage']['image']){
...
export default FacebookmanageScreenshot;