...
class SearchResult_M extends Component {
    ...
    initFunc = () => {
        ...
        if(this.props.info!==undefined && this.props.info.screenshot!==undefined){
            ...
            this.screenshot1 = prefix+(this.screenshot.m_place)
            // this.screenshot1 = prefix+(this.screenshot.m_place).replace("b'",'').replace(`'`,'')
            // this.screenshot1 = 'data:image/jpeg;base64,'+this.screenshot1;
	
            if(this.props.info.screenshot.m_place2 !=='' && this.props.info.screenshot.m_place2!==undefined){
	            this.screenshot2 = prefix+(this.screenshot.m_place2)
	            // this.screenshot2 = (this.screenshot.m_place2).replace("b'",'').replace(`'`,'')
                ...
                <div className="card">
                    ...
                    <div className="card_body">
                        ...
                        <div className="row result">
                            <div className="row-4-2 column" id="screenshot_M_1">
                                <img src=
                                    {this.screenshot===''?'':this.screenshot1}
                                    alt="screenshot"
                                />
                            </div>
                            <div className="row-4-2 column" id="screenshot_M_2">
                                <img src=
